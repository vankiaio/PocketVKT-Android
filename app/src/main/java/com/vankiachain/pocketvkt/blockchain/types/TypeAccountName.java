package com.vankiachain.pocketvkt.blockchain.types;


import com.vankiachain.pocketvkt.blockchain.util.StringUtils;
...
public class TypeAccountName extends TypeName {
    ...
    public TypeAccountName(String name) {
        ...
        if (! StringUtils.isEmpty( name )) {
            ...
            if ( (name.indexOf( CHAR_NOT_ALLOWED) >= 0) && ! name.startsWith("vktio.") ){
