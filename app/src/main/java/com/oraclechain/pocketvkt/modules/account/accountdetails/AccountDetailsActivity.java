...
import com.oraclechain.pocketvkt.bean.QrCodeAccountBean;
import com.oraclechain.pocketvkt.bean.QrCodeAccountPrivateKeyBean;
...
import com.oraclechain.pocketvkt.modules.resourcemanager.resourcehome.activity.ResourceManagerActivity;
...
import com.oraclechain.pocketvkt.utils.ViewToImageUtils;
import com.oraclechain.pocketvkt.view.CustomSlideToUnlockView;
import com.oraclechain.pocketvkt.view.dialog.confimdialog.Callback;
import com.oraclechain.pocketvkt.view.dialog.confimdialog.ConfirmDialog;
import com.oraclechain.pocketvkt.view.dialog.importprivatekeydialog.ImportPrivateKeyDialog;
import com.oraclechain.pocketvkt.view.dialog.importprivatekeydialog.ImportrivateKeyCallBack;
...
import com.oraclechain.pocketvkt.view.dialog.sharedialog.ShareCallBack;
import com.oraclechain.pocketvkt.view.dialog.sharedialog.ShareDialog;
                    ...
                    dialog = new ShareDialog(AccountDetailsActivity.this, new ShareCallBack() {
                        ...
                        public void goQQFriend() {
                            ...
                            params.putString(QQShare.SHARE_TO_QQ_IMAGE_LOCAL_URL, FilesUtils.savePhoto(ViewToImageUtils.loadBitmapFromView(mRel), Environment
                                    .getExternalStorageDirectory().getAbsolutePath() + "/pocketVkt/accountCode", String
