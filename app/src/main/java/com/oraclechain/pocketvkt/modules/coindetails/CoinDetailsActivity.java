...
import com.oraclechain.pocketvkt.modules.empty.EmptyActivity;
...
import com.oraclechain.pocketvkt.modules.transaction.makecollections.MakeCollectionsActivity;
...
import com.oraclechain.pocketvkt.utils.ChartUtil;
                ...
                if (dialog == null) {
                    ...
                    dialog = new ShareCoinDetailsDialog(CoinDetailsActivity.this, new ShareCoinDetailsCallBack() {
                        ...
                        public void goWeixinFriend() {
                            WxShareAndLoginUtils.WxUrlShare(CoinDetailsActivity.this, "https://pocketvkt.com", accountWithCoinBean.getCoinName() + "最新资讯详情", finalDesc,
