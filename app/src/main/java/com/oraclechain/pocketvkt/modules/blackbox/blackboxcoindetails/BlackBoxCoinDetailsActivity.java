package com.oraclechain.pocketvkt.modules.blackbox.blackboxcoindetails;
...
import com.oraclechain.pocketvkt.modules.coindetails.CoinDetailsPresenter;
import com.oraclechain.pocketvkt.modules.coindetails.CoinDetailsView;
...
import com.oraclechain.pocketvkt.modules.transaction.transferaccounts.TransferAccountsActivity;
import com.oraclechain.pocketvkt.utils.StringUtils;
import com.oraclechain.pocketvkt.view.DrawableCenterTextView;
import com.oraclechain.pocketvkt.view.dialog.sharecoindetailsdialog.ShareCoinDetailsCallBack;
import com.oraclechain.pocketvkt.view.dialog.sharecoindetailsdialog.ShareCoinDetailsDialog;
                ...
                if (dialog == null) {
                    ...
                    dialog = new ShareCoinDetailsDialog(BlackBoxCoinDetailsActivity.this, new ShareCoinDetailsCallBack() {
                        ...
                        public void goWeixinFriend() {
                            WxShareAndLoginUtils.WxUrlShare(BlackBoxCoinDetailsActivity.this, "https://pocketvkt.com", accountWithCoinBean.getCoinName() + "最新资讯详情", finalDesc,
                        ...
                        public void goQQFriend() {
                            ...
                            params.putString(QQShare.SHARE_TO_QQ_TARGET_URL, "https://pocketvkt.com");// 内容地址
                            params.putString(QQShare.SHARE_TO_QQ_IMAGE_URL, "http://pocketvkt.oss-cn-beijing.aliyuncs.com/yl/pocketvkt.png?Expires=1839400748&OSSAccessKeyId=LTAIdWMZ4ikcYbmF&Signature=dAyqIz3DfCq4emFtdUu%2F%2Fq7kQYU%3D");
                        ...
                        public void goQzone() {
                            ...
                            params.putString(QzoneShare.SHARE_TO_QQ_TARGET_URL, "https://pocketvkt.com");// 内容地址
                            ArrayList<String> imgUrlList = new ArrayList<>();
                            imgUrlList.add("http://pocketvkt.oss-cn-beijing.aliyuncs.com/yl/pocketvkt.png?Expires=1839400748&OSSAccessKeyId=LTAIdWMZ4ikcYbmF&Signature=dAyqIz3DfCq4emFtdUu%2F%2Fq7kQYU%3D");
